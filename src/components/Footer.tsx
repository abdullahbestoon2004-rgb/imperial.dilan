...
export function Footer() {
  return (
    <footer className="bg-[#2A1D0C] text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 font-['Inter']">
              <li>
                <a href="#" className="text-white/70 hover:text-[#8C673D] transition-colors">
                  Suits
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 border border-white/30 flex items-center justify-center hover:border-[#8C673D] hover:text-[#8C673D] transition-colors"
              >
                <Instagram size={20} />
              </a>
              <a
