    ...
    <>
      ...
      <section className="py-16 bg-[#E8E1D8]">
        <div className="max-w-[1700px] mx-auto px-4 md:px-6">
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            {wishlistCount > 0 ? (
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-[#6E6A66] px-5 py-2 font-['Inter'] text-sm text-[#2F2F2F] transition-colors hover:border-[#B67A2D] hover:text-[#B67A2D]"
              >
          ...
          {wishlistCount === 0 ? (
            <div className="rounded-sm border border-[#6E6A66]/35 bg-[#F1EBE2] px-6 py-16 text-center">
              ...
              <Link
                to="/suits"
                className="inline-flex items-center justify-center rounded-full bg-[#3A2418] px-6 py-3 font-['Inter'] text-sm tracking-[0.14em] text-[#E7D7C4] transition-colors hover:bg-[#4A2F20]"
              >
                BROWSE PRODUCTS
              </Link>
            </div>
