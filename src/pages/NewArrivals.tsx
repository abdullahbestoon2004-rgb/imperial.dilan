...
export default function NewArrivals() {
  ...
  return (
    <>
      <section className="relative h-[65vh] bg-[#E8E1D8] flex items-center justify-center">
        <img
          src="/dilan2.png"
          alt="New arrivals collection"
          className="absolute top-0 left-1/2 h-full w-full max-w-[1935px] -translate-x-1/2 object-cover object-center"
        />
        <div className="absolute top-0 left-1/2 h-full w-full max-w-[1935px] -translate-x-1/2 bg-gradient-to-b from-[#2F2F2F]/45 via-[#2F2F2F]/55 to-[#2F2F2F]/75" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {dropCards.map((drop, index) => (
              <motion.article
                ...
                className="relative overflow-hidden rounded-sm min-h-[230px]"
              >
                <img
                  src={drop.image}
                  alt={drop.title}
                ...
                <div className="relative z-10 p-6 h-full flex flex-col justify-end">
                  ...
                  <h2 className="font-['Playfair_Display'] text-3xl text-[#F6F3EE] mt-2">{drop.title}</h2>
                  <p className="font-['Inter'] text-sm text-[#F6F3EE]/78 mt-2">{drop.subtitle}</p>
                </div>
              </motion.article>
            ))}
          </div>
