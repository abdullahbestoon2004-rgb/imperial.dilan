...
export default function Suits() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-[60vh] bg-[#1B1411] flex items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0E0E0E]/50 to-[#0E0E0E]/70"></div>
        <div className="relative z-10 text-center px-6">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-6xl md:text-7xl font-['Playfair_Display'] text-[#E7D7C4] mb-4"
          >
            Premium Suits
          </motion.h1>
          <motion.p
            ...
            className="text-xl text-[#E7D7C4]/80 font-['Inter']"
          >
      ...
      {/* Main Content */}
      <section className="py-16 bg-[#3A2418]">
        <div className="max-w-[1700px] mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-[#E7D7C4] border border-[#6E6A66] px-6 py-3 pr-10 font-['Inter'] text-[#1B1411] cursor-pointer hover:border-[#D6A25B] transition-colors focus:outline-none focus:border-[#D6A25B]"
                >
                ...
                <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6E6A66] pointer-events-none" />
              </div>
            ...
            <div className="flex items-center gap-3">
              <span className="text-[#E7D7C4]/70 font-['Inter'] text-sm">Sort by:</span>
              <div className="relative">
                <select
                  value={sortBy}
