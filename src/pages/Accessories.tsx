  ...
  return (
    <>
      <section className="relative h-[60vh] bg-[#E8E1D8] flex items-center justify-center">
        <img
          src="https://images.unsplash.com/photo-1715446929992-3f3d2b7a9467?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        />
        <div className="absolute top-0 left-1/2 h-full w-full max-w-[1935px] -translate-x-1/2 bg-gradient-to-b from-[#2F2F2F]/55 to-[#2F2F2F]/75" />
